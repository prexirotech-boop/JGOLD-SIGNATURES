# Supabase Deployment & Integration Guide for JGOLD SIGNATURES
...
2. Create a new project (e.g., `JGOLD SIGNATURES ECOM`).
...
4. Click **New Query**, and copy/paste the entire contents of the master database script:
   👉 [supabase_master_setup.sql](file:///c:/Users/Admin/Downloads/JGOLD%20ECOM/supabase_master_setup.sql)
...
supabase secrets set ADMIN_EMAIL=admin@jgoldsignatures.com.ng
supabase secrets set FROM_EMAIL="JGOLD SIGNATURES <orders@jgoldsignatures.com.ng>"
supabase secrets set STORE_URL=https://jgoldsignatures.com.ng
```
...
To ensure emails send from `orders@jgoldsignatures.com.ng` instead of a generic domain, follow these steps in your [Resend](https://resend.com) account:
1. Register on [Resend.com](https://resend.com).
2. Go to **Domains** → **Add Domain** → Enter `jgoldsignatures.com.ng`.
...
1. Open the local [.env](file:///c:/Users/Admin/Downloads/JGOLD%20ECOM/.env) file.
